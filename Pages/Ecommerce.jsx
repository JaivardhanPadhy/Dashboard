...
import {useStateContext, userStateContext} from '../Contexts/ContextProvider';
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className='text-2xl'>$64,398.60</p>
            </div>
          </div>
        <div>
          <Button
              ...
              <div className='border-r-1 border-color m-4 pr-10'>
                  <div>
                    <p>
                      ...
                      <span className='p-1.5 hover:drop-shadow-xl rounded-full
                       text-white cursor-pointer bg-green-400 ml-3 text-xs'>23%</span>
                    </p>
